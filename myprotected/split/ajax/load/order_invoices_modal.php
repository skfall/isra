<?php 
	...
	$ah = new ajaxHelp($dbh);
	$content_id = isset($_POST['id']) ? $_POST['id'] : 0;
	...
	<body>
		...
		<div style="padding: 30px;">
		   	<div class='zen-form-item' style="width:100%;">
		   		<h2 style="font-size: 20px; padding: 5px;">Новый инвойс (заказ #<?= $content_id ?>)</h2>
				<div class='zif-wrap-date' style="text-align: left; float: left; width: 25%;">
