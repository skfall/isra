<?php 
	...
	$itemsList = $zh->getPackings($params);

	$totalItems = $zh->getPackings($params,true);
	...
	$filter1_options = array( 'By ID'=>'M.id', 'By Title'=>'M.title' );
	...
	$tableColumns = array(
						  ...
						  'Title'				=>	array('type'=>'title',		'field'=>'title'),
						  'Цена'				=>	array('type'=>'price',		'field'=>'price'),
						  'Просмотр'			=>	array('type'=>'cardView',	'field'=>'Смотреть', 'lpx'=>false),
